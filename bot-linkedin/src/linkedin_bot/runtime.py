"""Stub pipeline + controller for LinkedIn."""
...
def load_direction() -> Direction:
    if not DIRECTION_PATH.exists():
        return Direction(brand_name="LinkedIn stub")
...
async def run_pipeline(controller: BotController, request: RunRequest) -> None:
    ...
    controller.set_step("stub", "LinkedIn pipeline not implemented")
    raise NotImplementedError(
        "bot-linkedin is a stub. Implement LinkedIn observation ingest before running."
    )
